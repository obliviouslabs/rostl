...
pub fn benchmark_sort<T: Measurement + 'static>(c: &mut Criterion<T>) {
  ...
  for &size in &[100, 316, 1_000, 3_162, 10_000, 31_623, 100_000, 316_228, 1_000_000] {
...
criterion_group!(benches_time, benchmark_sort);
criterion_group!(
  name = benches_cycles;
  config = Criterion::default().with_measurement(CyclesPerByte);
  targets = benchmark_sort<CyclesPerByte>
);
